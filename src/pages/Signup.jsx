          ...
          >
            ...
            <div className="flex flex-col text-secondary py-2">
              ...
              <input
                ...
                className="rounded-lg bg-white px-3 py-3 mt-2 pt-2 border border-gray-300 focus:border-blue-400 focus:bg-[#FFF8F4] focus:outline-[#933D24] dark:placeholder-gray-400 dark:text-secondary"
                type="email"
            ...
            <div className="flex flex-col lg:flex-row gap-4 ">
              ...
              <div className="flex flex-col w-full text-secondary py-2">
                ...
                <input
                  ...
                  className="rounded-lg bg-white px-2 py-3 mt-2 pt-2  items-center  border  border-gray-300 focus:border-blue-400 focus:bg-white focus:outline-primary"
                  type="password"
                  placeholder="•••••••••"
                  value={confirmPwd}
                  onChange={(e) => {
